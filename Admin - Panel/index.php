    ...
    <section class="AdminMain">
      ...
      <div class="DoctorsDiv AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <!-- nandito ako -->
              <input type="text" placeholder="Search" id="searchDoctor" onkeyup="searchDoctor(this.value)">
      ...
      <div class="AccountsDiv AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <input type="text" id="AccSearch" title="search" placeholder="Search" onkeyup="searchAcc(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
      ...
      <div class="ArchivesDiv AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            <div class="InputText3">
              <input type="text" id="archSearch" title="search" placeholder="Search" onkeyup="searchArch(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
      ...
      <div class="HMO_Div AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <input type="text" placeholder="Search" onkeyup="searchHMO(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
      ...
      <div class="Room_Div AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <input type="text" id="roomsearch" title="search" placeholder="Search" onkeyup="searchRoom(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
        <div class="MainDiv-Main DoctorsDiv-Main">
          <div class="Table-Div">
            <table>
              ...
              <tbody class="tbody-archived Room_tbl">
                <?php
      ...
      <div class="Specialization_Div AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <input type="text" id="speci-search" title="search" placeholder="Search" onkeyup="searchSpecial(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
        <div class="MainDiv-Main DoctorsDiv-Main">
          <div class="Table-Div">
            <table>
              ...
              <tbody class="tbody-archived spec-tbl">
                <?php
      ...
      <div class="SubSpecialization_Div AdminMainDiv">
        <div class="MainDiv-Header">
          ...
          <div class="MainDiv-Header-Right">
            ...
            <div class="InputText3">
              <input type="text" id="subspeciSearch" title="search" placeholder="Search" onkeyup="searchSubSpec(this.value)">
              <i class="fa-solid fa-magnifying-glass"></i>
            </div>
          </div>
        </div>
        <div class="MainDiv-Main DoctorsDiv-Main">
          <div class="Table-Div">
            <table>
              ...
              <tbody class="tbody-archived subspeci-tbl">
                <?php
